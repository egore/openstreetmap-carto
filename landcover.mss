...
#sports-grounds {
  ...
  [leisure = 'track'][zoom >= 12] {
    polygon-fill: @track;
    line-width: 0.5;
    line-color: #888;
  }

  [leisure = 'pitch'][zoom >= 12] {
    polygon-fill: @pitch;
    line-width: 0.5;
    line-color: #888;
  }
